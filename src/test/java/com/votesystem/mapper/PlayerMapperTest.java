...
public class PlayerMapperTest {
    ...
    void insertUser() {
        ...
        int l;
//        System.out.println("s = " + l + "@qq.com");
        for (int i = 0; i < 1; i++) {
            l = random.nextInt(999999999);
//            账号
            users.setUserAccount(String.valueOf(l) + "@qq.com");
//            性别
            users.setUserSex(name_sex);
//            权限
            users.setUserScale("3");
//            账号状
            users.setUserStatus(1);
//            电话号码
            users.setUserTelephone(getTel());
//            姓名
            users.setUserRealName(getChineseName());
//            密码
